              ...
              <div className="space-y-3">
                ...
                {isCapacitor ? (
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-3 rounded-2xl border-2 border-gray-200 flex items-center justify-center gap-3 font-bold text-sm text-gray-600 bg-white hover:bg-gray-50 active:scale-95 transition-all shadow-sm"
                  >
